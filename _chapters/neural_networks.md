...
includes: [mathjax, jquery, i18next, convnetjs, dataset, convnet, visualizer]
...
{% include demo_insert.html path="/demos/simple_forward_pass/" parent_div="post" language="en" %}
